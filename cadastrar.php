    ...
    <div class="container">
        <div class="row">
            <div class="rol-md-12">
                ...
                <form name="formulario" method="POST" action="inserirdados.php">
			    ...
			    <input class="btn btn-success btn-lg mb-5" type="submit" name="btnLogin" value="Enviar" onclick = "return validar()">
			    
			    <h4 class="text-light">Lembrou da sua conta ? Clique no botão para realizar seu login</h4>
			    <a href="index.php" class="btn btn-light btn-lg mb-5 mt-5 mr-5">Mendes-Atacado</a>
