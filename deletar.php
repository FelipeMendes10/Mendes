  ...
  <body>
    ...
    <script type="text/javascript">
        ...
        function validar(){
            ...
            alert("Atenção!!! Você Deletou seus usuário!")
        }
        ...
        <div class="row">
            <div class="rol-md-12">
                <h2 class=" text-center text-light mb-5">Mendes-Atacado</h2>
                  ...
                  <h2 class=" text-center text-light mb-5">Confirme seus dados, para DELETAR seu Usuário</h2>
                  
                  
                
                <form name="formulario" method="POST" action="delete.php">
